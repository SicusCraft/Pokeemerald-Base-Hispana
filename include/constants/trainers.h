...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_BACK_ROCKY_GRUNT,
    TRAINER_PIC_BACK_ROXY_GRUNT,
};

#define TRAINER_BACK_PIC_PLAYER_MALE (TRAINER_PIC_BACK_ROCKY_GRUNT)
#define TRAINER_BACK_PIC_PLAYER_FEMALE (TRAINER_PIC_BACK_ROXY_GRUNT)
