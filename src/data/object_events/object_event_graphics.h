...
const u32 gObjectEventPic_MayNormalRunning[] = INCBIN_U32("graphics/object_events/pics/people/roxy/grunt/walking.4bpp", "graphics/object_events/pics/people/roxy/grunt/running.4bpp");
const u16 gObjectEventPal_May[] = INCBIN_U16("graphics/object_events/palettes/roxy.gbapal");
